...
from backend.app.auth.utils import (
    generate_password_hash, generate_username, verify_password, create_activation_token, generate_otp
)
...
class UserAuthService:
    ...
    async def reset_user_state(
        self, user: User, session: AsyncSession, *, clear_otp: bool = True, log_action: bool = True,
    ) -> None:
